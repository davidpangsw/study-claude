...
3. Assess the task's complexity：
   a. **If the task is SIMPLE** (can be completed in a single focused effort without major decomposition):
      - Complete the task directly
      - Review what you have done and make sure no problem
      - Report what you accomplished
      - End with "✓ Task completed"

   b. **If the task is COMPLEX** (requires multiple distinct steps, phases, or significant planning):
...
4. Review your work critically. If there is any problem, go back to step 3. This process should continue infinitely until you cannot find any problem.
